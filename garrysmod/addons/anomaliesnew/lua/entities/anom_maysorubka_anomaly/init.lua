...
function ENT:StartTouch(ent)
	...
	timer.Create("myasorubka_activated_once", 0.1, 1, function()
        ...
        dmgInfo:SetDamage(32)                    -- Set the damage amount
        ...
        dmgInfo:SetDamageType(DMG_BLAST)          -- Set the damage type to DMG_ACID
	...
	timer.Create("myasorubka_activated", 1.4, 0, function()
        ...
        dmgInfo:SetAttacker(self)                 -- Set the attacker (the entity itself)
        dmgInfo:SetInflictor(self)                -- Set the inflictor (also the entity itself)
        dmgInfo:SetDamageType(DMG_BLAST)          -- Set the damage type
