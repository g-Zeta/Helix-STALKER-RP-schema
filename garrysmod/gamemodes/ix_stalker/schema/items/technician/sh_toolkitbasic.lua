...
ITEM.description = "A set of tools for basic work on weapons."
ITEM.longdesc = "A children's toolkit. Unlikely to be suitable for fine work, but given the deficit of tools in the Zone, could be useful for a thrifty technician."
ITEM.model = "models/flaymi/anomaly/dynamics/equipments/quest/box_toolkit_1.mdl"
...
ITEM.sound = "stalker/inventory/inv_repair_kit_use_fast.mp3"
...
ITEM.functions.use = { 
		...
		if (char) then
			...
			if (inv) then
				...
				for k, v in pairs(items) do
					if (v.isWeapon and v:GetData("equip") != true) and item.repairTreshhold < (v:GetData("durability", 0)) and v:GetData("durability", 0) < 10000 then
    ...
    OnCanRun = function(item)				
		...
		if (char and char:HasFlags("7")) then
