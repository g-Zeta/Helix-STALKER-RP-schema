...
LANGUAGE = {
	...
	optObserverESPRange = "ESP Draw Distance",
	optdObserverESPRange = "Maximum draw distance for observer ESP labels and markers.",
	...
	optRadiationDisplayRange = "Radiation Display Range",
