...
LANGUAGE = {
	...
	introTextOne = "this schema presents",
	introTextTwo = "another STALKER RP gamemode",
	...
	chooseDescription = "Define your profile",
	chooseLoadout = "Choose your equipment",
	chooseSkills = "Assign your statistics",
	name = "Name",
	...
	optImperial = "Imperial weight units",
	optdImperial = "Switches to Imperial units for weight.",
	optDisableHUD = "HUD disabler",
	optdDisableHUD = "Disables the HUD.",
	optPersonalchatcolor = "Personal Chat Color",
	optGasmaskoverlay = "Dynamic Gasmask Overlays",
	optdGasmaskoverlay = "Disables the dynamic gasmask overlay.",
	optGasmaskbreathsound = "Gasmask Breathing Sound",
	optdGasmaskbreathsound = "Disables the gasmask breathing sound effect.",
	optCrosshair = "Crosshair disabler",
	optdCrosshair = "Disables the crosshair.",
	optCursor = "STALKER Cursor",
	optdCursor = "Disables the STALKER cursor.",
	optStalkerHUD = "STALKER 2 HUD",
	optdStalkerHUD = "Choose between SHoC and STALKER 2 HUD.",
	optPDAskin = "PDA skin",
	optdPDAskin = "Choose your PDA skin.",
	...
	["optObserverESP - NPCs"] = "ESP - NPCs",
	["optdObserverESP - NPCs"] = "Shows NPCs and nextbots in observer mode.",
	["optObserverESP - Items"] = "ESP - Items",
	["optdObserverESP - Items"] = "Shows dropped items in observer mode.",
	["optObserverESP - Shipment"] = "ESP - Shipments",
	["optdObserverESP - Shipment"] = "Shows shipments in observer mode.",
	["optObserverESP - Radiation"] = "ESP - Radiation",
	["optdObserverESP - Radiation"] = "Shows radiation zones in observer mode.",
	["optObserverESP - Psi"] = "ESP - Psi",
	["optdObserverESP - Psi"] = "Shows psi zones in observer mode.",
	["optObserverESP - Anomalies"] = "ESP - Anomalies",
	["optdObserverESP - Anomalies"] = "Shows anomaly entities in observer mode.",
	optChatIndicators = "Chat indicators",
	optdChatIndicators = "Shows typing indicators above players who are typing.",
	optAnomalySpawnerDisplayRange = "Anomaly spawner display range",
	optdAnomalySpawnerDisplayRange = "Draw distance for anomaly spawner bounding boxes and labels.",
	optRadiationDisplayRange = "Radiation + radiation spawner display range",
	optdRadiationDisplayRange = "Draw distance for radiation zone bounding boxes, labels, and ESP spheres.",
