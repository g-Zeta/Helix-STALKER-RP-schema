...
function PANEL:Init()
	...
	self.name:SetFont("stalkerregularboldfont")

	self.description = self:Add("DLabel")
	self.description:DockMargin(5, 5, 0, 0)
...
function PANEL:Init()
	self:DockMargin(54 * ScrW() / 1920, 4 * ScrH() / 1080, 700 * ScrW() / 1920, 0)
	self:SetTall(32)
...
function PANEL:Init()
	...
	self:Dock(FILL)
	self:DockMargin(0, 82 * ScrW() / 1920, 0, 42 * ScrH() / 1080)
