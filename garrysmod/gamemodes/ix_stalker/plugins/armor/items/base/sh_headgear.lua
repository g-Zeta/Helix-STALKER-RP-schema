	...
	function ITEM:PopulateTooltip(tooltip)
		if !self.entity then
			...
			for i = 1, #self.ballisticlevels do				
				...
				elseif self.ballisticlevels[i] == "l" then		--0.010
					brighttext:SetTextColor(Color(255, 80, 0))
				elseif self.ballisticlevels[i] == "ll-a" then	--0.015
					brighttext:SetTextColor(Color(255, 160, 0))
				elseif self.ballisticlevels[i] == "ll" then		--0.020
					brighttext:SetTextColor(Color(255, 255, 0))
				elseif self.ballisticlevels[i] == "lll-a" then	--0.025
					brighttext:SetTextColor(Color(130, 255, 0))
				elseif self.ballisticlevels[i] == "lll" then	--0.030
					brighttext:SetTextColor(Color(0, 255, 0))
				elseif self.ballisticlevels[i] == "lll+" then	--0.035
					brighttext:SetTextColor(Color(0, 255, 130))
				elseif self.ballisticlevels[i] == "lV" then		--0.040
					brighttext:SetTextColor(Color(0, 255, 255))
				elseif self.ballisticlevels[i] == "V" then		--0.045
